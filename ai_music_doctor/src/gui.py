...
class HardwareKnob(QWidget):
    ...
    def paintEvent(self, event):
        ...
        knob_size = min(w, h - 35) - 16
        knob_x = (w - knob_size) // 2
        knob_y = 15
        
        center_x = w // 2
        center_y = knob_y + knob_size // 2
        tick_radius = knob_size // 2 + 6
        ...
        label_y = h - 18
        painter.drawText(0, label_y, w, 18, Qt.AlignCenter, self.label)
        ...
        painter.drawText(0, label_y - 12, w, 12, Qt.AlignCenter, value_text)
...
class MainWindow(QMainWindow):
    ...
    def _create_knob_panel(self) -> QWidget:
        ...
        reverb_layout.setContentsMargins(2, 12, 2, 2)
        reverb_layout.setSpacing(3)
        ...
        self.knob_reverb.setMinimumSize(58, 100)
        self.knob_reverb.setMaximumSize(90, 130)
        reverb_layout.addWidget(self.knob_reverb)
